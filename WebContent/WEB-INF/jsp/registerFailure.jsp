...
<body>
	...
	<form id="create" name="register" action="welcome" method=post
		...
		<fieldset>
			...
			<input type="text" name="firstname" value="${fn}" maxlength="25"> <span class="exception">${fnException}${#fnException}</span>
			<p>
				<strong>Please Enter Your Last Name: </strong> 
			</p>
			<input type="text" name="lastname" value="${lastname}" maxlength="25"> <span class="exception">${lnException}${#lnException}</span>
			<p>
				<strong>Please Enter Home Address: </strong> 
			</p>
			<input type="text" name="address" value="${address}"> <span class="exception">${addressException}</span>
			<p>
				<strong>Please Enter Your City: </strong> 
			</p> 
			<input type="text" name="city" value="${city}"> <span class="exception">${cityException}${#cityException}</span>
			<p>
			...
			<input maxlength="5" name="zip" minlength="5" value="${zip}"> <span  class="exception">${zipException} ${letterZipException}</span>
			<p>
				<strong>Please Enter Your Date of Birth (mm/dd/yyyy): </strong>
			</p>
			<input type="date" name="dob" value="2015-04-23" min="1900-01-01" max="2015-04-24" value="${dob}"> <span  class="exception">${dobException}</span>
			<p>
				<strong>Please Enter Your Email Address: </strong>
			</p>
			<input type="email" name="email" value="${email}"> <span  class="exception">${emailException} </span>
		...
		<fieldset>
			...
			<input type="text" name="username" value="${username}"> <span  class="exception">${usernameException} ${usernameExists }</span>
			<p>
			<p>
		...
		<fieldset>
			...
			<p>
				<strong>Please Choose your type of Banking Account: </strong> ${acctTypeException}
			</p>
			<p>
