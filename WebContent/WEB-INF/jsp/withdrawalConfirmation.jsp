...
<body>
	...
	<div
		...
		<form name="deposit" action="newBalance"
			onSubmit="return validation()" method="POST">
			<table>

				
				<tr>
					<td><strong>Are you sure you want to withdrawal this amount?</strong> <input
						type="text" name="amount"  value="${amount}"></td>
				</tr>
			</table>
			<p>
				<input type="submit" value="Yes"> <a href="home">Cancel</a>
			</p>
		</form>
		<br> <br> <br>
		<table>
